    ...
    render(){
        return(
            ...
            <div style={{display:"flex",width:"80%",justifyContent:"space-between",marginTop:"70px",background:"rgba(0, 0, 0, 0)",margin:"auto",position:"relative",zIndex:"2"}}>
                ...
                <div className="Track">
                    <p style={{fontSize:"16px",fontWeight:"bold",color:"#B5B0C1"}}>Track in real time</p>
                    <div className="row">
                ...
                <p style={{fontSize:"16px",fontWeight:"bold",color:"#B5B0C1"}}>Shopfloor collaboration</p>
                <div className="row">
                ...
                <div className="Smart">
                <p style={{fontSize:"16px",fontWeight:"bold",color:"#B5B0C1"}}>
